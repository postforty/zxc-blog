...
import { useState } from 'react'; // useState is not directly used in the original, but usePosts might use it internally
...
const PostManagementPageClient = () => {
  ...
  const handleEdit = (postId: number) => {
    router.push(`/editor/${postId}`); // Changed from navigate
  };
...
export default PostManagementPageClient;
